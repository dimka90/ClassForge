...
interface CourseSelectionProps {
  ...
  handleCourseSelection: (courseId: string, selected: boolean) => void;
}

const CourseSelection: React.FC<CourseSelectionProps> = ({ filteredCourses, selectedCourses, handleCourseSelection }) => {
  return (
