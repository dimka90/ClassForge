...
exports.default = Invigilators;
const react_1 = require("react");
const lucide_react_1 = require("lucide-react");
function Invigilators() {
    const [existingInvigilators, setExistingInvigilators] = (0, react_1.useState)([
        {
            id: "existing-1",
    ...
    return (<div>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {existingInvigilators.map((invigilator) => (<tr key={invigilator.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex space-x-2">
                        <button onClick={() => handleEditInvigilator(invigilator.id)} className="text-[#212121] hover:text-blue-800" title="Edit invigilator">
                          <lucide_react_1.Edit2 className="w-4 h-4"/>
                        </button>
                        <button onClick={() => handleDeleteInvigilator(invigilator.id)} className="text-[#212121] hover:text-red-800" title="Delete invigilator">
        ...
        {existingInvigilators.length === 0 && (<div className="text-center py-8 text-gray-500">
