    ...
    const handleSubmit = (e) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (response.ok) {
                ...
                react_hot_toast_1.default.error(data.message || "Login failed");
            }
        }
        catch (error) {
        ...
        <div className="w-full max-w-md mx-auto flex flex-col gap-5">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3 text-sm">
            ...
            <div className="flex flex-col relative">
              ...
              <input type={showPassword ? "text" : "password"} id="password" value={password} onChange={(e) => setPassword(e.target.value)} className="border border-gray-300 text-gray-700 rounded-md px-3 py-2 focus:ring-1 focus:ring-black focus:border-black" placeholder="**********"/>
              ...
              {showPassword ? (<lucide_react_1.Eye className="w-5 h-5"/>) : (<lucide_react_1.EyeOff className="w-5 h-5"/>)}
              </button>
            </div>
            <div className="flex justify-between text-xs text-gray-700">
              <div className="flex items-center gap-2">
                <input type="checkbox" id="rememberMe" checked={rememberMe} onChange={(e) => setRememberMe(e.target.checked)} className="w-3 h-3 accent-black"/>
          ...
          <p className="text-center mt-3 text-xs text-gray-500">
            ...
            <span className="underline underline-offset-1 font-bold text-gray-900 hover:text-black">
              <link_1.default href="/register">SIGN UP HERE</link_1.default>
            </span>
          </p>
        </div>
      </div>
